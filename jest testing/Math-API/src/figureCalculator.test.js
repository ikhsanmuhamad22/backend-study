...
describe('A FigureCalculator', () => {
  ...
  describe('A calculateTrianglePerimeter function', () => {
    ...
    it('should throw error when given with non-number parameters', () => {
      ...
      expect(() => figureCalculator.calculateTrianglePerimeter(null, '2', undefined)).toThrowError();
      expect(() => figureCalculator.calculateTrianglePerimeter([], {}, '7')).toThrowError();
    });
  ...
  describe('A calculateTriangleArea function', () => {
    ...
    it('should return correct value based on rectangle area formula', () => {
      ...
      expect(spyDevide).toHaveBeenCalledWith(200, 2)
    });
  });
});